...
data['Dirección']=data['Dirección'].str.replace(',','_')
data['Latitud']=data['Latitud'].str.replace(',','.').astype(float)
data['Localidad']=data['Localidad'].str.replace(',','_')
data['Rótulo']=data['Rótulo'].str.replace(',','_')
data['Horario']=data['Horario'].str.replace(',','_')
